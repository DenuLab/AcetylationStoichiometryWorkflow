...
# Reading in data
spec_lib <- read.csv("./Spectral_Libraries/Hek_stoich_curve_HPRP_inflated.csv")
...
#write.table(spec_lib_isotope, file = "./Spectral_Libraries/20181113_HSC_spec_lib_inflated_label.csv", sep = ",", row.names = FALSE)
