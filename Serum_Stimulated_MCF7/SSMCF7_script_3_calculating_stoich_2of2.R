...
data <- read.csv("./Serum_starve_TC/SSMCF7_Spectronaut_analysis/20181031_SSMCF7_stoich_Spectronaut10_reprocess_correctFASTA_2ndhalf.csv")
...
# write.table(frg_sum, file = "./Serum_Stimulated_MCF7/Cleaned/20181101_SS_tc_tidy_frag_stoich_output_REPROCESS_2ndhalf.csv", sep = ",", row.names = FALSE)
# write.table(pep_sum, file = "./Serum_Stimulated_MCF7/Cleaned/20181101_SS_tc_tidy_peptide_stoich_output_REPROCESS_2ndhalf.csv", sep = ",", row.names = FALSE)
